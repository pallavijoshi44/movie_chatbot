...
const String MOVIE_RESPONSE = "I am about to show you my recommendations. You can tap on any of the movie cards to check how you can watch that movie in your location and possibly watch a trailer.";
...
const String TMDB_CONTENT = 'This product uses the TMDb API but is not endorsed or certified by TMDb.';
const String POWERED_BY_TMDB = 'The movie recommendations are powered by TMDb.';
const String POWERED_BY_JUST_WATCH = 'The watch providers data is powered by JustWatch.';
const String HELP = 'Help';
const String HELP_CONTENT = 'Help';
