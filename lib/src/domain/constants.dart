...
const String UNKNOWN_RESPONSE =
    "Looks like things are not going well, you can use the reset button to start over.";
const String START_OVER_TEXT =
...
const String NO_MOVIE_WATCH_TEXT = 'No ways to watch in';
const String NO_TV_WATCH_TEXT = 'No ways to watch in';
...
const MOVIE_RECOMMENDATIONS_EVENT = "MOVIE_RECOMMENDATIONS";
const TV_RECOMMENDATIONS_EVENT = "TV_SHOW_RECOMMENDATIONS";
